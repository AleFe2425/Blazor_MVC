...
namespace Blazor_MVC.Controllers
{
    public class AlumnoCalificacionController
    {
        ...
        {
            firestoreDb = FirestoreDb.Create("blazorserverdb-eba67"); // ID de base de datos
        }
        ...
        public async Task<bool> EditAlumnoCalificacion(AlumnoCalificaciones alumnoCalificacionesToUpdate)
        {
            try
            {
                DocumentReference alumnoCalificacionRef = firestoreDb
                    .Collection("AlumnoCalificaciones")
                    .Document(alumnoCalificacionesToUpdate.AlumnoCalificacionId);
            ...
            {
                Console.WriteLine($"Error al editar la calificación de un alumno: {ex.Message}");
                return false;
            }
        }
        ...
        public async Task<List<AlumnoCalificaciones>> GetAllAlumnosCalificacion()
        {
            ...
            {
                Console.WriteLine($"Error al obtener todas las calificaciones: {ex.Message}");
        ...
        public async Task<bool> DeleteAlumnoCalif(string alumnoCalifId)
        {
            ...
            {
                Console.WriteLine($"Error al borrar la calificación: {ex.Message}");
                return false;
            }
        }
    }
